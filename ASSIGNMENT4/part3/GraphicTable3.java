...
public class GraphicTable3 extends JFrame {
	private Point center;
	private GraphicPlate3 plates[];
	private GraphicChopstick3 chops[];
	...
	GraphicTable3() {
		...
		plates = new GraphicPlate3[5];
		for(int i=0; i<5; i++) {
		plates[i] = 
			new GraphicPlate3(i, center, new Point(center.x, center.y-70), 20);
		}
		
		chops = new GraphicChopstick3[5];
		for(int i=0; i<5; i++) {
		chops[i] = new GraphicChopstick3(i, center, 
