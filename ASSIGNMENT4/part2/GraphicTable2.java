...
public class GraphicTable2 extends JFrame {
	private Point center;
	private GraphicPlate2 plates[];
	private GraphicChopstick2 chops[];
	...
	GraphicTable2() {
		...
		plates = new GraphicPlate2[5];
		for(int i=0; i<5; i++) {
		plates[i] = 
			new GraphicPlate2(i, center, new Point(center.x, center.y-70), 20);
		}
		
		chops = new GraphicChopstick2[5];
		for(int i=0; i<5; i++) {
		chops[i] = new GraphicChopstick2(i, center, 
