...
public class GraphicTable4 extends JFrame {
	private Point center;
	private GraphicPlate4 plates[];
	private GraphicChopstick4 chops[];
	...
	GraphicTable4() {
		...
		plates = new GraphicPlate4[5];
		for(int i=0; i<5; i++) {
		plates[i] = 
			new GraphicPlate4(i, center, new Point(center.x, center.y-70), 20);
		}
		
		chops = new GraphicChopstick4[5];
		for(int i=0; i<5; i++) {
		chops[i] = new GraphicChopstick4(i, center, 
