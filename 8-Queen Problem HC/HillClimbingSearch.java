...
public class HillClimbingSearch implements Runnable {
    ...
    private static volatile NQueen[] sharedSolution = null;
    ...
    public static NQueen[] getSharedSolution() {
    ...
    public NQueen[] nextBoard (NQueen[] presentBoard) {
        ...
        // only the first thread to find a solution stores it
        if (presentHeuristic == 0 && solutionFound.compareAndSet(false, true)) {
            finalSolution = presentBoard;
            sharedSolution = presentBoard;
        }
    }
